...
--
-- Name: football_match; Type: TABLE; Schema: public; Owner: user
--
...
CREATE TABLE public.football_match (
    ...
    CONSTRAINT football_match_away_score_check CHECK ((away_score >= 0)),
    CONSTRAINT football_match_home_score_check CHECK ((home_score >= 0))
);


ALTER TABLE public.football_match OWNER TO "user";

--
-- Name: football_match_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

ALTER TABLE public.football_match ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.football_match_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: football_player; Type: TABLE; Schema: public; Owner: user
--
...
CREATE TABLE public.football_player (
    ...
    CONSTRAINT football_player_number_check CHECK ((number >= 0))
);


ALTER TABLE public.football_player OWNER TO "user";

--
-- Name: football_player_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

ALTER TABLE public.football_player ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.football_player_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: football_team; Type: TABLE; Schema: public; Owner: user
--
...
ALTER TABLE public.football_team OWNER TO "user";

--
-- Name: football_team_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

ALTER TABLE public.football_team ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.football_team_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
25	Can add Клуб	7	add_team
26	Can change Клуб	7	change_team
27	Can delete Клуб	7	delete_team
28	Can view Клуб	7	view_team
29	Can add Игрок	8	add_player
30	Can change Игрок	8	change_player
31	Can delete Игрок	8	delete_player
32	Can view Игрок	8	view_player
33	Can add Матч	9	add_match
34	Can change Матч	9	change_match
35	Can delete Матч	9	delete_match
36	Can view Матч	9	view_match
\.
...
1	contenttypes	0001_initial	2025-05-04 19:12:06.846753+03
2	auth	0001_initial	2025-05-04 19:12:06.887776+03
3	admin	0001_initial	2025-05-04 19:12:06.899516+03
4	admin	0002_logentry_remove_auto_add	2025-05-04 19:12:06.903+03
5	admin	0003_logentry_add_action_flag_choices	2025-05-04 19:12:06.906532+03
6	contenttypes	0002_remove_content_type_name	2025-05-04 19:12:06.914892+03
7	auth	0002_alter_permission_name_max_length	2025-05-04 19:12:06.918884+03
8	auth	0003_alter_user_email_max_length	2025-05-04 19:12:06.922968+03
9	auth	0004_alter_user_username_opts	2025-05-04 19:12:06.926559+03
10	auth	0005_alter_user_last_login_null	2025-05-04 19:12:06.930294+03
11	auth	0006_require_contenttypes_0002	2025-05-04 19:12:06.930931+03
12	auth	0007_alter_validators_add_error_messages	2025-05-04 19:12:06.934189+03
13	auth	0008_alter_user_username_max_length	2025-05-04 19:12:06.94133+03
14	auth	0009_alter_user_last_name_max_length	2025-05-04 19:12:06.94531+03
15	auth	0010_alter_group_name_max_length	2025-05-04 19:12:06.949539+03
16	auth	0011_update_proxy_permissions	2025-05-04 19:12:06.952937+03
17	auth	0012_alter_user_first_name_max_length	2025-05-04 19:12:06.957161+03
18	football	0001_initial	2025-05-04 19:12:06.971404+03
19	sessions	0001_initial	2025-05-04 19:12:06.977168+03
\.
...
--
-- Data for Name: football_match; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.football_match (id, city, date, home_score, away_score, away_team_id, home_team_id) FROM stdin;
1	Мадрид	2025-05-07 21:20:30.88709+03	2	1	2	1
\.


--
-- Data for Name: football_player; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.football_player (id, name, "position", number, birth_date, team_id) FROM stdin;
1	Тибо Куртуа	GK	1	1992-05-11	1
2	Винисиус Жуниор	FW	7	2000-07-12	1
3	Коул Палмер	MF	20	2002-05-06	2
4	Антони	FW	7	2000-02-24	3
\.


--
-- Data for Name: football_team; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.football_team (id, name, country, foundation_date, stadium) FROM stdin;
1	Реал Мадрид	Испания	1902-03-06	Сантьяго Бернабеу
2	Челси	Англия	1905-03-10	Стэмфорд Бридж
3	Реал Бетис	Испания	1907-09-12	Бенито Вильямарин
4	Реал Сосьедад	Испания	1909-09-07	Аноэта
5	Вильярреал	Испания	1923-03-10	Эстадио де ла Серамика
\.
...
--
-- Name: football_match_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--

SELECT pg_catalog.setval('public.football_match_id_seq', 1, true);


--
-- Name: football_player_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--

SELECT pg_catalog.setval('public.football_player_id_seq', 4, true);


--
-- Name: football_team_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--

SELECT pg_catalog.setval('public.football_team_id_seq', 5, true);
...
--
-- Name: football_match football_match_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: football_player football_player_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: football_team football_team_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: football_match_away_team_id_f1e5daa0; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX football_match_away_team_id_f1e5daa0 ON public.football_match USING btree (away_team_id);


--
-- Name: football_match_home_team_id_440071d9; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX football_match_home_team_id_440071d9 ON public.football_match USING btree (home_team_id);


--
-- Name: football_player_team_id_fa7a6ba5; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX football_player_team_id_fa7a6ba5 ON public.football_player USING btree (team_id);
...
--
-- Name: football_match football_match_away_team_id_f1e5daa0_fk_football_team_id; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.football_match
    ADD CONSTRAINT football_match_away_team_id_f1e5daa0_fk_football_team_id FOREIGN KEY (away_team_id) REFERENCES public.football_team(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: football_match football_match_home_team_id_440071d9_fk_football_team_id; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.football_match
    ADD CONSTRAINT football_match_home_team_id_440071d9_fk_football_team_id FOREIGN KEY (home_team_id) REFERENCES public.football_team(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: football_player football_player_team_id_fa7a6ba5_fk_football_team_id; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.football_player
    ADD CONSTRAINT football_player_team_id_fa7a6ba5_fk_football_team_id FOREIGN KEY (team_id) REFERENCES public.football_team(id) DEFERRABLE INITIALLY DEFERRED;
